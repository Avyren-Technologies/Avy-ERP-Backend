...
export const createLeaveTypeSchema = z.object({
  ...
  accrualDay: z.coerce.number().int().min(1).max(31).optional(),
  ...
  maxConsecutiveDays: z.coerce.number().int().min(1).optional(),
  ...
  documentAfterDays: z.coerce.number().int().min(1).optional(),
