...
export const createLeaveTypeSchema = z.object({
  ...
  annualEntitlement: z.coerce.number().positive(),
  accrualFrequency: z.enum(['MONTHLY', 'QUARTERLY', 'ANNUAL', 'PRO_RATA', 'UPFRONT']).optional(),
  accrualDay: z.coerce.number().int().min(0).max(31).optional(),
  ...
  maxEncashableDays: z.coerce.number().min(0).optional(),
  encashmentRate: z.string().nullable().optional(),
  ...
  minTenureDays: z.coerce.number().int().min(0).optional(),
  minAdvanceNotice: z.coerce.number().int().min(0).optional(),
  minDaysPerApplication: z.coerce.number().min(0).optional(),
  maxConsecutiveDays: z.coerce.number().int().min(0).optional(),
  ...
  documentAfterDays: z.coerce.number().int().min(0).optional(),
