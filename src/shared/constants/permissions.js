...
exports.REFERENCE_ROLE_PERMISSIONS = exports.PERMISSION_MODULES = exports.PERMISSION_ACTIONS = void 0;
exports.getAllPermissions = getAllPermissions;
exports.hasPermission = hasPermission;
exports.PERMISSION_ACTIONS = ['view', 'create', 'edit', 'delete', 'approve', 'export', 'configure'];
...
function getAllPermissions() {
    var permissions = [];
    for (var _i = 0, _a = Object.entries(exports.PERMISSION_MODULES); _i < _a.length; _i++) {
        var _b = _a[_i], module_1 = _b[0], config = _b[1];
        for (var _c = 0, _d = config.actions; _c < _d.length; _c++) {
            var action = _d[_c];
            permissions.push("".concat(module_1, ":").concat(action));
        }
    }
    return permissions;
}
...
function hasPermission(userPermissions, required) {
    ...
    var module = required.split(':')[0];
    if (module && userPermissions.includes("".concat(module, ":*")))
        return true;
    return false;
}
/**
 ...
 */
exports.REFERENCE_ROLE_PERMISSIONS = {
    'General Manager': {
    ...
    'Auditor': {
        ...
        permissions: Object.keys(exports.PERMISSION_MODULES).map(function (m) { return "".concat(m, ":view"); }),
    },
    'Viewer': {
