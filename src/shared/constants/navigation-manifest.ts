...
export const NAVIGATION_MANIFEST: NavigationItem[] = [
  ...
  { id: 'ess-announcements', label: 'Announcements', icon: 'megaphone', requiredPerm: null, path: '/app/announcements', module: 'hr', group: 'My Workspace', roleScope: 'company', sortOrder: 315 },
  { id: 'ess-policies', label: 'Policy Documents', icon: 'book-open', requiredPerm: 'ess:view-policies', path: '/app/company/hr/policy-documents', module: 'hr', group: 'My Workspace', roleScope: 'company', sortOrder: 316 },
