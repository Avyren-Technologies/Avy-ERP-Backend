...
if (hasFlag('help') || hasFlag('h')) {
  ...
  Examples:
    ...
    npx tsx scripts/seed-company.ts --employees 5 --email superadmin@avyrentechnologies.com --password Password@123
  `);
  process.exit(0);
}
...
const ADMIN_PASSWORD = getArg('password', process.env.ADMIN_PASSWORD || 'Password@123');
